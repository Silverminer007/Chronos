...
public class MessageFormatter {
    ...
    public MessageFormatter(Person sendTo) {
        this.sendTo = sendTo;
    }
    ...
    public MessageFormatter person(Person person) {
        return this.person(person, "PERSON");
    }

    public MessageFormatter person(Person person, String name) {
        this.contexts.add(new PersonContext(person, name));
        return this;
    }

    public MessageFormatter organisation(Organisation organisation) {
        return this.organisation(organisation, "ORGANISATION");
    }

    public MessageFormatter organisation(Organisation organisation, String name) {
        this.contexts.add(new OrganisationContext(organisation, name));
        return this;
    }

    public MessageFormatter date(Date date) {
        return this.date(date, "DATE");
    }

    public MessageFormatter date(Date date, String name) {
        this.contexts.add(new DateContext(date, name));
        return this;
    }

    public MessageFormatter group(Group group) {
        return this.group(group, "GROUP");
    }

    public MessageFormatter group(Group group, String name) {
        this.contexts.add(new GroupContext(group, name));
        return this;
    }

    public MessageFormatter feedback(Feedback.Status feedback) {
        return this.feedback(feedback, "FEEDBACK");
    }

    public MessageFormatter feedback(Feedback.Status feedback, String name) {
