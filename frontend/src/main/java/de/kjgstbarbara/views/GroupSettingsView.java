...
@Route(value = "group-settings", layout = MainNavigationView.class)
@PageTitle("Einstellungen")
@PermitAll
public class GroupSettingsView extends VerticalLayout {

    public GroupSettingsView(PersonsService personsService, AuthenticationContext authenticationContext) {
    ...
    private Component createHeader() {
        ...
        header.add(new H4("Gruppen/Organisationen"));
        return header;
    }
    ...
    private Component createContent() {
        ...
        content.add(this.createLink("Gruppen", GroupView.class));
        content.add(this.createLink("Organisationen", OrganisationView.class));
        return content;
    }
