...
public class PhoneNumberField extends CustomField<Person.PhoneNumber> implements HasSize {
    ...
    public PhoneNumberField(Person person) {
        HorizontalLayout horizontalLayout = new HorizontalLayout();
        horizontalLayout.setSpacing(true);

        countryCode = new ComboBox<>(person.translate("phone-number.country-code"));
        ...
        subscriber = new IntegerField(person.translate("phone-number.number"));
